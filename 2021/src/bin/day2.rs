...
// forward X increases the horizontal position by X units. down X increases the depth by X units.
// up X decreases the depth by X units. Note that since you're on a submarine, down and up affect
// your depth, and so they have the opposite result of what you might expect.
...
// forward 5 adds 5 to your horizontal position, a total of 5. down 5 adds 5 to your depth,
// resulting in a value of 5. forward 8 adds 8 to your horizontal position, a total of 13. up 3
// decreases your depth by 3, resulting in a value of 2. down 8 adds 8 to your depth, resulting in
// a value of 10. forward 2 adds 2 to your horizontal position, a total of 15. After following
// these instructions, you would have a horizontal position of 15 and a depth of 10. (Multiplying
